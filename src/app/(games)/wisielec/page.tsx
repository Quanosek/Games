    ...
    return (
      <form
        ...
        onSubmit={(e) => {
          ...
          return open(`/wisielec/board/${index + 1}`, 'game_window', 'width=960, height=540')
        }}
      >
            ...
            <label>
              ...
              <input
                ...
                onBlur={() => {
                  setData((prev) => {
                    const newData = [...prev]
                    newData[index].category = newData[index].category.toUpperCase()
                    return newData
                  })
                }}
              />
      ...
      >
        <button
          ...
          onClick={() => {
            ...
            return open('/wisielec/board/0', 'game_window', 'width=960, height=540')
          }}
        >
          <p>Rozpocznij grę</p>
        </button>
